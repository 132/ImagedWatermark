function [SUM, Check_Dot, BinAm_Dot, BinDuong_Dot, GapAm_Dot, GapDuong_Dot, WI_Dot, size_W_Dot, KEY_Dot, Check_Cross, BinAm_Cross, BinDuong_Cross, GapAm_Cross, GapDuong_Cross, WI_Cross,size_W_Cross,KEY_Cross] = Embedding_DEMO(OI, watermark)

watermark=randi([0 1],1,10000/2); % random watermark theo bpp
watermark= watermark(:);
Denta = 1;
m = 1;
