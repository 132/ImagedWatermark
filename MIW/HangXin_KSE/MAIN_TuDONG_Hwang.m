...
%watermark= watermark(:);
function [MaxPSNR_Cross, MaxPSNR_Dot, WI_Cross, WI_Dot, T_Cross, T_Dot] = BangChinhThuc(OI,watermark)
...
[ABCD Histogram] = bin_CaiTien_TuDOng_XaiDuoc_Hwang(c_Cross,r_Cross,uh_Cross,u_Cross, watermark_Cross, PhanLoai(1));
...
for i = 1:length(ABCD(1,:))            
    ...
    [WI_Cross_Temp size_W_Cross KEY_Cross_Temp Check_Cross_Temp] = embedding__TuDong_Cross(Denta, m, Am1_Temp, Am2_Temp, Duong1_Temp, Duong2_Temp, OI ,watermark_Cross,c_Cross,r_Cross,uh_Cross,u_Cross, watermark_LSB);
...
[ABCD_Dot Histogram_Dot] = bin_CaiTien_TuDOng_XaiDuoc_Hwang(c_Dot,r_Dot,uh_Dot,u_Dot,watermark_Dot, PhanLoai_Dot(1));
MaxPSNR_Dot = 0;
